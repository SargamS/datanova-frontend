...
import { ArrowLeft, Download, FileJson, ImageIcon, ExternalLink, Figma, BookOpen, Info, Layout } from "lucide-react";
...
export default function ExportPage() {
  ...
  const handleKeyChange = (e: React.ChangeEvent<HTMLInputElement>) => setFileKey(e.target.value);
  ...
  return (
    <main className="min-h-screen bg-slate-50 p-8">
      ...
      <div className="max-w-7xl mx-auto">
        <Link href="/" className="flex items-center gap-2 text-sm mb-8 text-slate-500 hover:text-orange-600">
          <ArrowLeft size={16} /> Back to Dashboard
        </Link>

        <h1 className="text-4xl font-black text-slate-900 mb-2">Export & Design</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Card className="p-6 border-2 border-orange-100">
              ...
              <label className="text-xs font-bold uppercase text-slate-400">Figma File Key</label>
              <Input placeholder="Paste File Key from URL" value={fileKey} onChange={handleKeyChange} />

              <div className="mt-3 p-3 bg-blue-50 rounded flex gap-2">
                <Info size={14} className="text-blue-500 mt-1" />
                <p className="text-xs text-blue-700">URL format: figma.com/file/<b>FILE_KEY</b>/name</p>
              </div>
            </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="p-4">
                ...
                <Button onClick={downloadFigmaJSON} disabled={!sharedData} variant="ghost" className="w-full text-orange-600">
                  Download JSON
                </Button>
              </Card>
              ...
              <Card className="p-4">
                ...
                <Button onClick={generateReportImage} disabled={!sharedData} variant="ghost" className="w-full text-blue-600">
            ...
            <Card className="p-6">
              ...
              {resources.length > 0 ? (
                ...
                <p className="text-xs text-slate-400 italic">Analyze a dataset to see resources.</p>
              )}
            </Card>
          </div>
              ...
              <div className="h-[650px] border-2 border-dashed rounded-xl flex flex-col items-center justify-center text-slate-400">
                ...
                {imageUrl && (
                  <div className="mt-6 bg-white p-4 rounded shadow">
                    ...
                    <a href={imageUrl} download="DataNova_Report.png" className="flex items-center gap-1 text-blue-600 text-sm">
