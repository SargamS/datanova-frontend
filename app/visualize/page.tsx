...
import { ArrowLeft, BarChart3, LineChart, PieChart, TrendingUp, Sparkles, Loader2, Download, Figma } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-8">
            <header>
              ...
              <p className="text-slate-500 mt-2">Dataset: {sharedData?.fileName || "N/A"}</p>
            </header>

            {!selectedChart ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {chartTypes.map(chart => (
                  <Card key={chart.id} onClick={() => setSelectedChart(chart.id)}
              ...
              <Card className="p-8 border-2 border-orange-100 shadow-xl rounded-3xl">
                <div className="flex justify-between mb-6">
                  ...
                  <Button variant="outline" onClick={() => setSelectedChart(null)}>Change Chart</Button>
                </div>
